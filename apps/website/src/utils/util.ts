 ...
 * @returns {boolean}
 */
export function isNonNull(variable: any) {
 ...
 * @returns {boolean}
 */
export function isType(variable: any, type: any) {
 ...
 * @returns {boolean}
 */
export function isUint8Array(variable: any) {
 ...
 * @returns {boolean}
 */
export function isBigNumber(variable: any) {
 ...
 * @returns {boolean}
 */
export function isLong(variable: any) {
 ...
 * @returns {boolean}
 */
export function isStringOrUint8Array(variable: any) {
 ...
 * @returns {T}
 */
export function requireNotNegative(variable: any) {
 ...
 * @returns {object}
 */
export function requireNonNull(variable: any) {
 ...
 * @returns {object}
 */
export function requireType(variable: any, type: any) {
 ...
 * @returns {BigNumber}
 */
export function requireBigNumber(variable: any) {
 ...
 * @returns {Long}
 */
export function requireLong(variable: any) {
 ...
 * @returns {string}
 */
export function requireString(variable: any) {
 ...
 * @returns {Uint8Array}
 */
export function requireUint8Array(variable: any) {
 ...
 * @returns {number}
 */
export function requireNumber(variable: any) {
 ...
 */
export function requireStringOrUint8Array(variable: any) {
 ...
 * @returns {BigNumber}
 */
export function convertToBigNumber(variable: any) {
 ...
 */
export function convertToBigNumberArray(variable: any) {
 ...
 * @returns {DataView}
 */
export function safeView(arr: any, offset = 0, length = arr.byteLength) {
 ...
 * @returns {boolean}
 */
export function compare(a: any, b: any, ignore = new Set()) {
