...
const BondRequestsActiveFilter: React.FC<Props> = ({ handleSearchChange }) => {
  const setActiveMaturityDateRange = useBondRequestStore.use.setActiveMaturityDateRange();
...
export default BondRequestsActiveFilter;
